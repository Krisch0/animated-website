                    ...
                    if (!0 !== N.data(_ + "_intouch") &&
                        ...
                        if (!s.pointerType ||
                            ...
                            return (
                                ...
                                (L = a),
                                ct(),
                                _t(0, f), !l || I === v.fingers || v.fingers === h || st() ?
                                ((Y = wt()),
                                    2 == I &&
                        ...
                        if (
                            ...
                            if (
                                ((T = Ft(F.start, F.end)),
                                    ...
                                    (c = tt(o, R)), !v.triggerOnTouchEnd || v.triggerOnTouchLeave)
                            ) {
                                var w = !0;
                                v.triggerOnTouchLeave &&
                                    ((g = {
                                        ...
                                        (w =
                                            ...
                                            d.x < g.right &&
                                            d.y > g.top &&
                                            d.y < g.bottom)), !v.triggerOnTouchEnd && w ?
                                    (R = J(f)) :
        ...
        (n.fn.waitForImages = function(t, e, r) {
            if (
                (n.isPlainObject(t) &&
                    ...
                    (t = t || n.noop),
                    (e = e || n.noop),
                    (r = !!r), !n.isFunction(t) || !n.isFunction(e))
            )
    ...
    function(t, e, n) {
                    ...
                    function(t, s, f) {
                        ...
                        if (!x) {
                            if (!(y = "auto" === e.grid ? 0 : (e.grid || [1, k])[1])) {
                                for (
                                    m = -k; m < (m = f[y++].getBoundingClientRect().left) && y < C;
                        ...
                        if (
                            (g !== this._time &&
                                ...
                                ((c = this._yoyo),
                                    ...
                                    ((o = ~~(v / a)) && o === v / a && ((r = m), o--),
                                        r > m && (r = m)),
                                    (p = Yt(this._tTime, a)), !g && this._tTime && p !== o && (p = o),
                                    c && 1 & o && ((r = m - r), (d = 1)),
                                    o !== p && !this._lock))
                        ) {
                            var C = c && 1 & p,
                            ...
                            if (
                                (o < p && (C = !C),
                                    (g = C ? 0 : m),
                                    (this._lock = 1),
                                    (this.render(g || (d ? 0 : xt(o * a)), e, !m)._lock = 0), !e && this.parent && ce(this, "onRepeat"),
                        ...
                        if (
                            (this._hasPause &&
                                ...
                                ((this._onUpdate = this.vars.onUpdate),
                                    (this._initted = 1),
                                    (this._zTime = t)), !g && r && !e && ce(this, "onStart"),
                                r >= g && t >= 0)
                        )
                            for (i = this._first; i;) {
                                if (
            ...
            Ue = function(t, e, n, r, i, u) {
                ...
                if (
                    ...
                    (s = new pt[t]()).init(
                        ...
                        (function(t, e, n, r, i) {
                            if (
                                (j(t) && (t = qe(t, i, e, n, r)), !W(t) || (t.style && t.nodeType) || K(t) || Q(t))
                            )
                    ...
                    for (
                        a = n._ptLookup[n._targets.indexOf(i)], l = s._props.length; l--;
            ...
            We = function t(e, n) {
                ...
                if (
                    (N && (!T || !m) && (m = "none"),
                        ...
                        e._yoyo &&
                        !e._repeat &&
                        ((b = e._yEase), (e._yEase = e._ease), (e._ease = b)), !N)
                ) {
                    if (
                    ...
                    for (
                        e._pt = 0, C = (M && q(C)) || (C && !M), i = 0; i < S.length; i++
                    ) {
                        if (
                ...
                function e(e, n, i, s) {
                    ...
                    if (
                        ((o._targets = T.length ?
                                mt(T) :
                                ot(
                                    "GSAP target " + e + " not found. https://greensock.com", !P.nullTargetWarn
                                ) || []),
                            (o._ptLookup = []),
                            (o._overwrite = C),
                            x || y || H(_) || H(m))
                        ...
                        if (
                            ...
                            for (l = 0; l < f; l++) {
                                ...
                                E && (h.yoyoEase = E),
                                    ...
                                    (h.delay = (+qe(m, r(o), l, p, T) || 0) - o._delay), !y &&
                                    1 === f &&
                                    h.delay &&
                    ...
                    return (!0 === C && ((Xe = r(o)), u.killTweensOf(T), (Xe = 0)),
                        b && Ut(b, r(o)),
                        (v ||
                            (!_ &&
                                !x &&
                ...
                return (
                            ...
                            if (
                                ...
                                if (((r = d), (h = this.timeline), this._repeat)) {
                                    if (
                                        ...
                                        return this;
                                    u !== o &&
                                        (h && this._yEase && Pe(h, a), !this.vars.repeatRefresh ||
                                            a ||
                                            this._lock ||
                                            ((this._lock = n = 1),
                                ...
                                this._onUpdate &&
                                    ...
                                    (t < 0 &&
                                        ...
                                        (ce(
                                                this,
                                                d === p ? "onComplete" : "onReverseComplete", !0
                                            ),
                                            this._prom &&
                    ...
                    (n.kill = function(t, e) {
                        ...
                        if (
                            ...
                            (function(t, e) {
                                for (
                                    var n = t.length, r = n === e.length; r && n-- && t[n] === e[n];
        ...
        var dn,
            ...
            Hn = function(t, e, n) {
                ...
                for (
                    t = t.charAt(0).toUpperCase() + t.substr(1); i-- && !(Gn[i] + t in r);
            ...
            $n = function(t) {
                ...
                return (
                    (e && (e.width || e.height)) ||
                    t.getBBox === Kn ||
                    (e = Kn.call(t, !0)), !e || e.width || e.x || e.y ?
                    e :
                    {
                        x: +Zn(t, ["x", "cx", "x1"]) || 0,
                        y: +Zn(t, ["y", "cy", "y1"]) || 0,
                ...
                return i === h || !l || nr[i] || nr[h] ?
                    ...
                    ("px" !== h && !d && (l = t(e, n, r, "px")),
                        ...
                        ((f[D ? "width" : "height"] = 100 + (d ? h : i)),
                            (s = ~n.indexOf("adius") || ("em" === i && e.appendChild && !p) ?
                                e :
                                e.parentNode),
        ...
        function ci(t, e, n, r, i, u, s, o, a) {
            if (t !== o || e !== a) {
                ...
                isNaN(L) && (L = D), !s && L > 0 ? (L -= p) : s && L < 0 && (L += p),
                    (k %= p),
                    (L %= p);
                var N,
        ...
        var Ai,
            ...
            Ni = function(t, e) {
                ...
                if (
                    ...
                    for (
                        l.length = 4, n = g(D), r = 2 * Math.random() - 1, h = 2; h < f; h++
                    )
                        (p = n),
                        (a = r),
                        (n = g(D * h)),
        ...
        var Ii,
            ...
            eu = function(t, e) {
                ...
                return (
                    u < 0 && (u = r.indexOf(" ")),
                    (r = u < 0 ? e : Hi(r.substr(0, u)) || 1e-5) > e && (r = e), [Math.max(0, -i), Math.max(0, r - i)]
                );
            },
            nu = function() {
                Vi() &&
                ...
                if (
                    ...
                    ((u =
                            (r =
                                ...
                                (function(t) {
                                    for (
                                        var e = new Cu(), n = 0; n < t.numberOfItems; n++
                                    )
                    ...
                    if (((u = s = 0), fu))
                        for (
                            r = t.offsetParent, i = t; i && (i = i.parentNode) && i !== r && i.parentNode;
            ...
            ns = {
                ...
                render: function(t, e) {
                    ...
                    e.x < 0 && (e.x = 0),
                        e.y < 0 && (e.y = 0),
                        h &&
                        (!e.skipX && (u > s || u < -s) && n < Zu(a, "x") && (e.skipX = 1), !e.skipY && (i > s || i < -s) && r < Zu(a, "y") && (e.skipY = 1),
                            e.skipX &&
                            e.skipY &&
                            (l.kill(),
                                e.vars.onAutoKill &&
                ...
                for (o = 0; o < l; o++)
                    ...
                    (R &&
                        ((d = h.style),
                            ...
                            (d.display = "block"),
                            (d.width = h._w + 1 + "px"),
                            (d.height = h._h + "px")), !L && N ?
                        h._isSplit ?
                        ((h._next = h.nextSibling), h.parentNode.appendChild(h)) :
                        h.parentNode._isSplit ?
                        ((h._parent = h.parentNode), !h.previousSibling &&
                            h.firstChild &&
            ...
            Fs = function(t, e, n, r) {
                ...
                for (
                    ...
                    (i = (function t(e) {
                        ...
                        return r;
                    })((t = y))).indexOf("<"), !1 !== e.reduceWhiteSpace &&
        ...
        function Ms(t, e, n) {
            ...
            if (((r.width = 100), (r.height = 200), 0 === t.length)) i.fillStyle = n;
                ...
                for (
                    var u = i.createLinearGradient(0, 0, 100, 0), s = 0; s < t.length; s++
                )
        ...
        bs.getSSGColors = function(t, e, n) {
            if (
                ((n = void 0 === n ? "fading" : n), -1 === t.indexOf("gradient") && -1 === e.indexOf("gradient"))
            )
                return { from: t, to: e };

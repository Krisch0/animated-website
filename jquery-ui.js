!(function(t) {
    ...
    x.extend(x.expr[":"], {
        ...
        (x.ui.focusable = function(t, e) {
            ...
            return "area" === r ?
                ((n = (i = t.parentNode).name), !(!t.href || !n || "map" !== i.nodeName.toLowerCase()) &&
    ...
    (x.widget = function(t, i, e) {
        ...
        return (
            ...
            (o.prototype = x.widget.extend(
                s, { widgetEventPrefix: (n && s.widgetEventPrefix) || t },
                r, { constructor: o, namespace: l, widgetName: t, widgetFullName: a }
            )),
            n ?
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                if (((s = {}), (t = (i = t.split(".")).shift()), i.length)) {
                    for (
                        n = s[t] = x.widget.extend({}, this.options[t]), o = 0; o < i.length - 1; o++
                    )
                        (n[i[o]] = n[i[o]] || {}), (n = n[i[o]]);
